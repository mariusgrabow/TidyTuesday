...
ggplot(cricket)+
  ...
  theme_void()+
  xlab("\nYear")+
  ylab("Games won by away team\n")+
  labs(title = "<span style = 'font-size:47pt'>Cricket world cup winners<br> ",
       subtitle = "<span style = 'font-size:16pt'>Away teams are regularly <span style = 'color: #3B9AB2;'>winning</span> more games than <span style = 'color: #E1AF00;'>losing</span> against home teams<br> ",
  ...
  annotate("text", x = as.factor(2001), y = 105,
           label = "win loss delta \u394",
           size = 6,family="roboto slab",fontface="bold")+
  annotate("curve", x = as.factor(2001), xend = as.factor(1999),
           y = 100, yend = 78, size = 1.6, arrow = arrow(length = unit(0.1, "cm")),
           curvature = -0.15, colour = "black")
